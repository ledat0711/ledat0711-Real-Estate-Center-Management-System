...
public class NotificationRestController {
     ...
     * Function: Automatically delete notifications that were created more than 3 months ago.
     *
     */
    @Scheduled(fixedRate = 1000 * 60 * 60 * 24)
    public void autoDeleteOnceADay() {
        notificationService.autoDeleteNotification();
        System.out.println("The system has deleted the notifications that were created more than 3 months ago. \n");
    }
